// onclick on buttons to award badge to user id
// deduct points from user id for badge
// badge is now associated with user id name



// $.get("/api/user", function (dbBadge) {
